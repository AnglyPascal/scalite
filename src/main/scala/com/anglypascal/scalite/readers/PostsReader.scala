...
import com.anglypascal.scalite.bags.Tag
...
class PostsReader(directory: String, globals: Obj)
    extends DirectoryReader[Post](directory):
  ...
  /** Add each post to the Tag collections. If the Tag object for the tag name
    ...
    *
    * TODO: This needs to change significantly
    */
...
object PostsReader:
  def apply(
    ...
    (new PostsReader(directory, globals)).getObjectMap(layouts)
