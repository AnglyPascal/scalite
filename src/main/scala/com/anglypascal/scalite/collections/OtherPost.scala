...
import com.anglypascal.scalite.documents.OtherPage
...
/** Reads the content of a post file and prepares a Post object.
  ...
  */
abstract class OtherPostTrait(rType: String)(
...
class OtherPost(rType: String)(
    parentDir: String,
    relativePath: String,
    globals: IObj,
    collection: IObj
) extends OtherPostTrait(rType)(parentDir, relativePath, globals, collection)
    with OtherPage
